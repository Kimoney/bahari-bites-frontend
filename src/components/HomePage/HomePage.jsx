...
import {  FaStar, FaHistory, FaBullseye, FaHeart, FaConciergeBell, FaUtensils, FaShoppingCart, FaCreditCard, FaTruck } from 'react-icons/fa';
...
<section id='testimonials' className="mt-12 py-16">
