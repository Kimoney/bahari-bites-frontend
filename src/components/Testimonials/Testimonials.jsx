...
export default function Testimonials() {
  return (
    <div className="mt-12 py-16 px-4">
      <h3 className="text-3xl font-bold text-center text-orange-500 mb-8">Testimonials</h3>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          ...
          <div
            key={index}
            className="bg-white p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:border-orange-500 border-2 border-transparent hover:shadow-xl"
          >
